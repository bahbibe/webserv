...
// webserv binary and the unit test binary can link the rest of the
// codebase without pulling in main.cpp's own int main() - a
// translation unit can only have one of those.
t_events ep;
